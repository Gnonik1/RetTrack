...
<!-- Public URL: https://gnonik1.github.io/rettrack-legal/terms-of-use/ -->

**Effective Date:** May 12, 2026

## 1. Acceptance of Terms

These Terms of Use (“Terms”) govern your access to and use of RetTrack, an independent mobile application developed and operated by Giorgi Nonikashvili (“RetTrack,” “we,” “us,” or “our”).

By downloading, accessing, or using RetTrack, you agree to these Terms. If you do not agree to these Terms, you must not use RetTrack.

## 2. Relationship to Apple Standard EULA

If you download RetTrack through the Apple App Store, your use of RetTrack is also subject to Apple’s Standard End User License Agreement, unless a separate custom license agreement is provided through Apple’s App Store processes.

These Terms supplement Apple’s Standard End User License Agreement by setting out RetTrack-specific rules, responsibilities, and limitations for use of the app and related features.

If there is a conflict between these Terms and any mandatory terms required by Apple, applicable App Store rules, or applicable law, the mandatory terms will control to the extent of the conflict.

## 3. What RetTrack Does

RetTrack is designed to help users organize purchase information, return dates, purchase photos, purchase status, and related reminders. RetTrack may allow users to create purchase entries, attach photos, track return windows, mark purchases as returned or kept, and receive reminder-related functionality.
...
You remain solely responsible for verifying store policies, return windows, receipts, product condition requirements, shipping requirements, deadlines, and any other return-related conditions.
...
RetTrack does not guarantee that reminders will always be delivered, delivered on time, or displayed as expected.
...
Guest-mode data is stored locally on your device and may not be recoverable if you delete the app, reset your device, or clear local app data. If you create or sign in to an account, RetTrack may allow guest purchases to be migrated to your signed-in account.
...
Account deletion may remove or disable access to your account and associated data, subject to any limited retention required for legal, security, fraud-prevention, backup, or compliance purposes.

Deleting the app from your device does not necessarily delete synced account data. If you want to delete a signed-in RetTrack account, you should use the in-app account deletion feature or contact us at:
...
You retain any rights you have in your User Content. You grant RetTrack a limited, non-exclusive, worldwide license to store, process, display, transmit, and otherwise use your User Content solely as necessary to provide, maintain, secure, and operate RetTrack.
...
1. attempt to gain unauthorized access to any account, system, database, storage bucket, or service connected to RetTrack;

2. interfere with, disrupt, abuse, overload, or attempt to bypass the security or technical limitations of RetTrack;

3. reverse engineer, decompile, or attempt to extract source code from RetTrack, except where such restriction is prohibited by applicable law;

4. use RetTrack for unlawful, fraudulent, deceptive, harmful, or abusive purposes;

5. upload or store content that infringes intellectual property rights, violates privacy rights, or violates applicable law;

6. misuse authentication, storage, sharing, reminder, or sync features;
...
We do not warrant that RetTrack will be uninterrupted, error-free, secure, available at all times, or that reminders, sync, storage, or other features will always work as expected.
...
Because RetTrack may be made available internationally, nothing in these Terms is intended to limit any mandatory rights or protections that you may have under the laws of your country or region, including applicable consumer protection and data protection laws.
